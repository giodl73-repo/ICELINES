---
wave: fire-the-kiln
pulse: icelines-signals-roster-full-filter-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-roster-full-filter-20260624

## Mission

Pin the Signals roster full-evidence filter JSON path and operator guide example without promoting roster output into a leaderboard/filter catalog/cache claim.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-roster-full-filter-20260624`
- `git diff --check`
