---
wave: fire-the-kiln
pulse: icelines-signals-export-authority-docs-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-export-authority-docs-20260624

## Mission

Tighten WP-010 Signals markdown export source-authority documentation and VTRACE evidence wording without promoting cache, filters, leaderboards, StatId, prediction, or coaching claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-export-authority-docs-20260624`
- `git diff --check`
