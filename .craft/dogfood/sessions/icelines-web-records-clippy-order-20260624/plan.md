---
wave: fire-the-kiln
pulse: icelines-web-records-clippy-order-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-web-records-clippy-order-20260624

## Mission

Repair the pre-existing icelines-web records.rs clippy::items-after-test-module blocker by moving helper items before the test module, restoring the web clippy gate without changing route behavior.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-web-records-clippy-order-20260624`
- `git diff --check`
