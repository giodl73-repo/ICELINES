---
wave: fire-the-kiln
pulse: icelines-signals-val012-trace-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-val012-trace-20260624

## Mission

Align VAL-012 trace linkage with current WP-010 Signals roster evidence without promoting StatId/filter/leaderboard/cache claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-val012-trace-20260624`
- `git diff --check`
