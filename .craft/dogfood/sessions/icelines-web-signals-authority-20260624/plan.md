---
wave: fire-the-kiln
pulse: icelines-web-signals-authority-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-web-signals-authority-20260624

## Mission

Render and pin Web player Signals HTML source-authority details so the Web surface preserves source, coverage state, covered inputs, covered metrics, and blocked claims without promoting filter catalog, StatId, leaderboard, cache, prediction, or coaching claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-web-signals-authority-20260624`
- `git diff --check`
