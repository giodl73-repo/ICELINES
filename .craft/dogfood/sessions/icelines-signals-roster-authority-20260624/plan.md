---
wave: fire-the-kiln
pulse: icelines-signals-roster-authority-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-roster-authority-20260624

## Mission

Pin signals-roster text output source-authority and non-promotion copy so WP-010 roster discovery keeps the same evidence semantics as single-player Signals without promoting filter catalog, StatId, leaderboard, cache, prediction, or coaching claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-roster-authority-20260624`
- `git diff --check`
