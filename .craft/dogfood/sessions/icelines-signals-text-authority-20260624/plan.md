---
wave: fire-the-kiln
pulse: icelines-signals-text-authority-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-text-authority-20260624

## Mission

Pin single-player signals text source-authority details so the CLI text surface preserves source, coverage state, covered inputs, covered metrics, and blocked claims without promoting filter catalog, StatId, leaderboard, cache, prediction, or coaching claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-text-authority-20260624`
- `git diff --check`
