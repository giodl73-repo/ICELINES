---
wave: fire-the-kiln
pulse: icelines-cache-routes-operator-guide-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-cache-routes-operator-guide-20260624

## Mission

Document WP-009 analytics-cache evidence routes in COMMANDS.md with unavailable/no-live/non-prediction boundaries, without promoting broader cache-backed product surfaces.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-cache-routes-operator-guide-20260624`
- `git diff --check`
