---
wave: fire-the-kiln
pulse: icelines-team-signals-link-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-team-signals-link-20260624

## Mission

WP-010: link the team-scoped Web Signals roster discovery surface from the team page without promoting Signals to leaderboards, StatId, filters, or cache.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-team-signals-link-20260624`
- `git diff --check`
