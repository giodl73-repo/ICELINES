---
wave: fire-the-kiln
pulse: icelines-receipt-dirt-preflight
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-receipt-dirt-preflight

## Mission

Verify craft commit-rules treats CRAFT receipt artifacts as non-product dirt before the next icelines product pulse.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-receipt-dirt-preflight`
- `git diff --check`
