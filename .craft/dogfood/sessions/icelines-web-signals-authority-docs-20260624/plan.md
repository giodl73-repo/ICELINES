---
wave: fire-the-kiln
pulse: icelines-web-signals-authority-docs-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-web-signals-authority-docs-20260624

## Mission

Align COMMANDS.md Signals operator copy with Web HTML source-authority details, documenting that Web HTML now exposes source, coverage state, covered inputs, covered metrics, blocked claims, and limitations without promoting filter catalog, StatId, leaderboard, cache, prediction, or coaching claims.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-web-signals-authority-docs-20260624`
- `git diff --check`
