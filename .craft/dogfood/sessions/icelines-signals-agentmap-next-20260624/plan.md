---
wave: fire-the-kiln
pulse: icelines-signals-agentmap-next-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-agentmap-next-20260624

## Mission

Use the icelines AgentMap product machine to advance the active Signals node with a bounded evidence-backed slice, preserving non-promotion boundaries.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-agentmap-next-20260624`
- `git diff --check`
