---
wave: fire-the-kiln
pulse: icelines-signals-roster-web-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-signals-roster-web-20260624

## Mission

WP-010: expose team-scoped Signals roster discovery on Web HTML/JSON using a shared core ViewModel, preserving non-leaderboard and non-promotion boundaries.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-signals-roster-web-20260624`
- `git diff --check`
