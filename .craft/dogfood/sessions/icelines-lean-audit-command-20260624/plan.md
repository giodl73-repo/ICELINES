---
wave: fire-the-kiln
pulse: icelines-lean-audit-command-20260624
date: 2026-06-22
status: planned
req:
  - REQ-DOGFOOD-001
...
# Craft Chat Pulse icelines-lean-audit-command-20260624

## Mission

Expose the existing WP-007 lean/dependency-seam audit script in COMMANDS.md and VTRACE evidence without claiming lean CLI support.
...
- `craft dogfood pulse gate --workspace-root <ROOT> --session icelines-lean-audit-command-20260624`
- `git diff --check`
