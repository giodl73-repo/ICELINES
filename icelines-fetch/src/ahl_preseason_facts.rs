...
pub struct AhlPreseasonAssignmentAuthority {
    pub method: String,
    pub as_of: String,
...
mod tests {
    ...
    fn ledger(authority: AhlProfessionalGamePolicyAuthority) -> AhlProfessionalGameLedgerView {
        AhlProfessionalGameLedgerView {
            ...
            age_qualification_effective_season: Some(20262027),
            european_elite_youth_exemption_effective_season: Some(20262027),
            as_of: "2026-07-28".to_owned(),
            threshold: 260,
