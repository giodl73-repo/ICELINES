...
| WP-003 | Harden Web dashboard route and browser safety behavior. | REQ-WEB-001; REQ-WEB-002; REQ-WB-002; REQ-PARITY-001 | web handlers/templates/CSS/assets, JSON twins, launch command | Shared ViewModel/context behavior is available or explicitly stubbed. | No-JS shell, active context, URL state, GET-read-only, recovery, viewport, and host/bind checks recorded. | L0: route tests; L1: workspace checks; L2: browser/no-JS inspection | closed_with_risk; pulses 01-07 season-type GET-read-only, favorites cache-read-only, streaks missing-cache, scoring missing-cache, Admin data-status missing-cache, browser shell/recovery, and serve launch/bind route boundaries passed_with_risk; Phase Hurricane 3a/3b selected scoring confidence ranges and project-command pace outlook rows plus Phase Hurricane 4b selected Web goalie advanced workload rows passed_with_risk; residual live-browser/touch-focus/full-JSON-matrix and team-outlook confidence risk routed to WP-008/future work |
| WP-004 | Add historical perspective and report/export evidence. | REQ-STAT-001; REQ-STAT-002; REQ-REPORT-001; REQ-PARITY-001 | report/export commands, scoring/perspective models, fixtures, snapshots, CLI leaders/career output, TUI dashboard history panel | Fixture list covers lockout, rollover, ambiguous names, trades, active streaks, GP thresholds, and completeness. | Report/export snapshots, selected CLI text outputs, and selected TUI/dashboard/Web compare output disclose scope and avoid unsupported claims; edge observations are separate. | L0: fixture/snapshot tests; L1: workspace checks; L2: VAL-002/VAL-004 review | closed_with_risk; pulses 01-08 selected Markdown export disclosure guardrail, active-streak status label, completeness/skeleton disclosure, GP-threshold export evidence, duplicate/Unicode-name evidence, trade-continuity evidence, lockout/October rollover season-window evidence, full-lockout season skip evidence, Phase Hurricane 5a/5b/5c selected CLI career-arc/leaders aggregate and TUI dashboard bundled-history depth disclosure, Phase Hurricane 6a selected CLI career-arc sparkline visualization, Phase Hurricane 6b selected Markdown compare-report SVG visualization, Phase Hurricane 6c selected Web compare SVG visualization, Phase Hurricane 6d selected Markdown leaders SVG visualization, Phase Hurricane 6e selected Web leaders SVG visualization, Phase Hurricane 6f selected Web player SVG visualization, Phase Hurricane 6g selected TUI sparkline hardening, Phase Hurricane 6h selected Web team SVG visualization, Phase Hurricane 6i selected Web goalie SVG visualization, Phase Hurricane 6j selected Web scoring outlook SVG visualization, Phase Hurricane 6k selected Web records SVG visualization, Phase Hurricane 6l selected Web report SVG visualization, Phase Hurricane 6m selected Markdown team-season SVG visualization, Phase Hurricane 6n selected Markdown depth SVG visualization, Phase Hurricane 6o selected Markdown fantasy SVG visualization, Phase Hurricane 6p selected Markdown roster SVG visualization, Phase Hurricane 6q selected Markdown team SVG visualization, Phase Hurricane 6r selected Markdown series SVG visualization, Phase Hurricane 6s selected TUI playoff sparkline visualization, Phase Hurricane 6t selected TUI team-season sparkline visualization, Phase Hurricane 6u selected TUI schedule matchup sparkline visualization, Phase Hurricane 6v selected TUI game-detail activity-bar visualization, Phase Hurricane 6w selected TUI player-records count-bar visualization, Phase Hurricane 6x selected TUI goalie SV% bar visualization, Phase Hurricane 6y selected TUI Stats leaders primary-metric bar visualization, and Phase Hurricane 6z selected TUI team roster Pts/82 bar visualization passed_with_risk; compact visualization train closed with residual broader interactive TUI and future secondary chart-shape risk |
...
| WP-010 | Define the first IceLines Signals metric family and selected surfaces. | REQ-SIGNAL-001; REQ-DATA-001; REQ-STAT-001; REQ-CODE-001 | `icelines-core::signal_metrics`, `icelines-core::view_model::signals`, CLI `icelines signals`, TUI player card, Web player Signals routes, signal methodology spec, future stat/cache/report surfaces | CHG-073 through CHG-076 accepted; first signal formulas, evidence tiers, ViewModel boundary, CLI/TUI/Web surface copy, and non-claim boundaries selected. | Core descriptors, formulas, required-input evidence, missing-input refusal, methodology limitations, internal ViewModel preservation, CLI text/JSON, TUI player-card, and Web HTML/JSON evidence are recorded without promoting stable `StatId`, report/export, cache, filter, or leaderboard claims. | L0: signal formula/evidence/ViewModel fixtures; L1: affected CLI/Web clippy/format; L2: CLI command and Web route fixtures | partial; pulses 01-04 passed selected core descriptor/formula/missing-input evidence, internal ViewModel preservation, CLI text/JSON `signals.v1`, TUI player-card rendering, and Web player Signals HTML/JSON evidence for Physical Engagement Rate, Puck Management Differential, and Penalty Drag Rate |
...
| L2 | yes | `VAL-002` and `VAL-004` report/export review evidence. | passed_with_risk for `VAL-002`: pulses 01-08 selected Markdown export public-copy, active-streak status, completeness/skeleton, GP-threshold, duplicate/Unicode-name, trade-continuity, season-window, and full-lockout skip reviews passed_with_risk; Phase Hurricane 5a/5b/5c add selected CLI career-arc/leaders aggregate and TUI dashboard bundled-history data-depth disclosure evidence; Phase Hurricane 6a-6z add selected descriptive visualization and TUI hardening evidence across CLI, Markdown, Web, reports, dashboard sparklines, playoff detail, team-season detail, schedule matchup detail, game detail, player-records detail, goalie leaderboard, Stats leaders rows, and team roster rows. Full report/export matrix remains pending overall under `VAL-004` and future work. |

V closure: see `TRACE.md` WP-004 and `VERIFICATION.md` EVID-VAL-002A/B/C/D,
EVID-WP004-CLI-CAREER-DEPTH-L0, EVID-WP004-CLI-CAREER-SPARKLINE-L0, EVID-WP004-EXPORT-COMPARE-SVG-L2, EVID-WP004-WEB-COMPARE-SVG-L1, EVID-WP004-EXPORT-LEADERS-SVG-L2, EVID-WP004-EXPORT-TEAM-SEASON-SVG-L0, EVID-WP004-EXPORT-DEPTH-SVG-L0, EVID-WP004-EXPORT-FANTASY-SVG-L0, EVID-WP004-EXPORT-ROSTER-SVG-L0, EVID-WP004-EXPORT-TEAM-SVG-L0, EVID-WP004-EXPORT-SERIES-SVG-L0, EVID-WP004-TUI-PLAYOFFS-SPARKLINE-L0, EVID-WP004-TUI-TEAM-SEASON-SPARKLINE-L0, EVID-WP004-TUI-SCHEDULE-MATCHUP-SPARKLINE-L0, EVID-WP004-TUI-GAME-DETAIL-ACTIVITY-L0, EVID-WP004-TUI-PLAYER-RECORDS-BAR-L0, EVID-WP004-TUI-GOALIES-SV-BAR-L0, EVID-WP004-TUI-LEADERS-PRIMARY-BAR-L0, EVID-WP004-TUI-TEAM-ROSTER-BAR-L0, EVID-WP004-WEB-LEADERS-SVG-L1, EVID-WP004-WEB-PLAYER-SVG-L1, EVID-WP004-TUI-SPARKLINE-HARDENING-L0, EVID-WP004-WEB-TEAM-SVG-L1, EVID-WP004-WEB-GOALIES-SVG-L1, EVID-WP004-WEB-OUTLOOK-SVG-L1, EVID-WP004-WEB-RECORDS-SVG-L0, EVID-WP004-WEB-REPORT-SVG-L0, EVID-WP004-TUI-HISTORY-DEPTH-L0, EVID-WP004-LOCKOUT-SKIP-L0, EVID-CR-007,
EVID-CR-012, EVID-CR-013, and EVID-CR-016. Status is closed_with_risk with
broader report/export matrix, broader active-streak parity, ambiguous-name
disambiguation breadth, and remaining streak/seasons-aggregate depth surfaces routed to
future work.
...
Phase Hurricane 5a/5b/5c add selected CLI player/compare career-arc, leaders aggregate, and TUI dashboard bundled-history depth disclosure. Phase Hurricane 6a/6b/6c/6d/6e/6f/6g/6h/6i/6j/6k/6l/6m/6n/6o/6p/6q/6r/6s/6t/6u/6v/6w/6x/6y/6z add selected CLI career-arc sparkline, Markdown compare-report SVG, Web compare SVG, Markdown leaders SVG, Web leaders SVG, Web player SVG, TUI dashboard sparkline hardening, Web team SVG, Web goalie SVG, Web scoring outlook SVG, Web records SVG, Web poach/weekly report SVG, Markdown team-season quality-ledger SVG, Markdown depth team-strength SVG, Markdown fantasy poach-score SVG, Markdown roster Pts/82 SVG, Markdown team Pts/82 SVG, Markdown series game-margin SVG, TUI playoff series game-margin sparkline, TUI team-season goal-differential sparkline, TUI schedule matchup margin sparkline, TUI game-detail skater-activity bar, TUI player-records count-bar, TUI goalie SV% bar, TUI Stats leaders primary-metric bar, and TUI team roster Pts/82 bar visualization evidence. The compact visualization train is closed with residual broader interactive TUI and future secondary chart-shape risk.
...
readiness route; pulse 11 accepted the first practice focus route; pulse 12
accepted the first postgame review route; pulse 13 accepted the first postgame
adjustment-review route; pulse 14 accepted the first agent evidence summary
route.
Implementation closure requires broader shipped-surface consumer and closeout
reviews.
...
- Define a signal descriptor and evidence API for descriptive composite hockey
  metrics.
...
- Preserve signal descriptors, evidence, values, methodology, limitations,
  ...
  CLI/TUI/Web user-facing surfaces.

Out of scope:

- Stable `StatId` promotion, leaderboard columns, filters, report/export
...
- `IF-SIGNAL-001` exposes descriptors, evidence tiers, missing-input details, and
  an internal ViewModel boundary.
...
- CLI text/JSON, TUI player-card, and Web HTML/JSON player Signals surfaces
...
| Level | Required | Planned Evidence | Status |
|---|---|---|---|
| L0 | yes | Signal descriptor, formula, missing-input, sample-size, TOI, polarity, ViewModel preservation, TUI render-helper, and Web HTML unavailable-state fixture tests. | partial; pulses 01-04 passed selected core fixtures, internal ViewModel preservation, CLI render fixtures, TUI render fixtures, and Web route/render fixtures for the first three Signals |
| L1 | yes | Affected core/CLI/Web format and clippy gates. | passed for pulse 04 affected slice |
| L2 | yes for user-facing surfaces | CLI command fixtures and Web route fixtures when Signals reach a user-facing surface. | passed for pulse 03 CLI text/JSON and pulse 04 Web HTML/JSON; TUI covered by focused render fixture |
...
Signals HTML and JSON routes exist, and the product methodology spec exists in
`design/specs/icelines-signals.md`. No stable stat-catalog, filter, leaderboard,
report/export, or cache claim is accepted yet.
...
text/JSON surface, and pulse 04 accepted the TUI player-card plus Web player
Signals surfaces, all with residual catalog/cache/report promotion risk.
