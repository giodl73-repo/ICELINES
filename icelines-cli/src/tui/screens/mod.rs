...
fn render_sdi(f: &mut Frame, app: &App) {
    ...
    match &app.screen {
        ...
        Screen::PlayerStreaksById(pid) => player_streaks::render_by_id(f, app, chunks[1], *pid),
...
fn chrome_screen_label(s: &Screen) -> &'static str {
    match s {
        ...
        Screen::PlayerStreaksById(_) => "Streaks",
...
fn render_mdi_workspace(f: &mut Frame, app: &App, mdi: &crate::tui::mdi::MdiLayout, area: Rect) {
    ...
    match &app.screen {
        ...
        Screen::PlayerStreaksById(pid) => player_streaks::render_by_id(f, app, inner, *pid),
