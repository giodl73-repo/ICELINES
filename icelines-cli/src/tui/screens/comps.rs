...
/// Hart.5c.6 Phase B-2.1 — view-based comps. Same algorithm as
/// `find_comps`, but operates on `PlayerView<'_>` slices. Pure
/// function so it's testable independent of the renderer.
