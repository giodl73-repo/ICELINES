...
| Watch rules | `WatchRulesView` | `watch ...` | watchlist workspace; rule editor deferred | `/watchlist` | `/api/v1/watch-rules`; `/api/v1/watchlist` | partial - rule preview/list/watch-note, persisted rules, toggles, and fired history wired; TUI editor deferred | Selke |
