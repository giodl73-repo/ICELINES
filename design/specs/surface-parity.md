...
| Team season performance | `TeamSeasonView` | `team-season <ABBR>` | `team <ABBR> season` | `/team/:abbrev/season` | `/api/v1/team/:abbrev/season` | planned - Phase Presidents Trophy; distinct from roster/depth and schedule list surfaces; target metrics include standings context, playoff distance, home/away splits, strength of schedule, quality wins/bad losses, recent form, and remaining schedule pressure | Presidents Trophy |
