...
| Docs reference | `DocsView` | `docs` | in-TUI docs overlay | `/docs` | n/a | partial - web docs and the TUI docs overlay project from `DocsView`; generated MkDocs nav keeps the durable guide/reference pages when team rankings regenerate | Lester Patrick/Ted Lindsay/Jim Gregory |
