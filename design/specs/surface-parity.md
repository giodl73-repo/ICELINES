...
| Playoffs | `PlayoffsView` | `playoffs` | `tui playoffs` | `/playoffs` | `/api/v1/playoffs` | partial - CLI playoffs, web HTML, and web JSON project through `PlayoffsView`; `PlayoffsSeriesRow` carries winner and games-played fields for CLI output; TUI adapter alignment remains | Lester Patrick/Ted Lindsay |
