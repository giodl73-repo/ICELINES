...
| [organization-window.md](organization-window.md) | Implemented (evaluation) | The Window composes versioned organization profiles into explainable 32-team health, horizon, movement, and scenario boards with configurable Frames; production source and future-holdout gates remain open. |
...
| [player-line-matchup-forecast.md](player-line-matchup-forecast.md) | Implemented (foundation) | The Matchup turns confidence-weighted player profiles, pair/trio evidence, opponent style, and manager execution into a sealed 5-on-5 game-edge feature while keeping deployment affinity and special teams separate. |
