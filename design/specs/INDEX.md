...
| [organization-window.md](organization-window.md) | Draft | The Window composes versioned organization profiles into explainable 32-team health, horizon, movement, and scenario boards with configurable Frames. |
