...
| Prince of Wales - ASPECT visual system | **Prince of Wales Trophy** *(next)* | Apply the DEGAS ASPECT rubric to TUI/web/CLI visual quality: shared visual tokens, scan rhythm, responsive web polish, CLI readability, and golden/screenshot tests. | Conference champion polish before the final release push. Plan: `plans/2026-05-09-phasePrinceOfWales-visual-system.md`. |
