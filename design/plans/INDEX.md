...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Sabres - Docs/reference truth gate](2026-06-21-phaseSabres-docs-reference-truth-gate.md) | Active | Close the docs/reference rollup placeholder with evidence-backed wording for CLI docs, TUI docs overlay, Web `/docs`, and removed mkdocs/static-site non-claims. |
