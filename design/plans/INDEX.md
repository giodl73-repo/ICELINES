...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Avalanche - Goalie readiness promotion gate](2026-06-20-phaseAvalanche-goalie-readiness-promotion.md) | Active | Decide whether the WP-009 goalie-readiness Web/API first-route evidence can become a bounded prepared-cache goalie readiness workload claim, or remain first-route evidence only. |
