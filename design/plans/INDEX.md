...
| [Phase Jack Adams Web - browser dashboard and command surface](2026-05-12-phaseJackAdamsWeb-web-mdi.md) | Active | Brings the TUI Jack Adams concepts to the browser: scores ribbon, Favorites/Watchlist and Schedule context panes, swappable workspace, command palette, responsive drawer behavior, and ViewModel-backed panels without a full SPA rewrite. |
