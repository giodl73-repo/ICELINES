...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Wild - Line-combination promotion gate](2026-06-20-phaseWild-line-combination-promotion.md) | Active | Decide whether the WP-009 line-combination Web/API first-route evidence can become a bounded prepared-cache line-combination explorer claim, or remain first-route evidence only. |
