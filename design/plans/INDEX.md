...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Bruins - Opponent scout promotion gate](2026-06-20-phaseBruins-opponent-scout-promotion.md) | Active | Decide whether the WP-009 opponent-scout Web/API first-route evidence can become a bounded prepared-cache scout report claim, or remain first-route evidence only. |
