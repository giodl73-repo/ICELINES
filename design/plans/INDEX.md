...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Predators - Postgame promotion gate](2026-06-20-phasePredators-postgame-promotion.md) | Active | Decide whether the WP-009 postgame review and adjustment Web/API first-route evidence can become bounded prepared-cache postgame report claims, or remain first-route evidence only. |
