...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Panthers - Signals row wording gate](2026-06-21-phasePanthers-signals-row-wording-gate.md) | Active | Convert the Player Signals surface row from plain partial wording to partial-by-design wording, preserving Capitals non-claims around cache, catalog, filter, leaderboard, and recommendation authority. |
