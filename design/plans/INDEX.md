...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Sharks - Analytics-cache route wording gate](2026-06-21-phaseSharks-analytics-cache-route-wording-gate.md) | Active | Convert player evidence-card and opponent-scout route rows from plain partial wording to bounded prepared-cache claims, preserving Stars/Bruins non-claims. |
