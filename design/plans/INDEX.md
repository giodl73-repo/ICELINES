...
| Plan | Status | Summary |
|------|--------|---------|
| [Phase Lightning - Career route wording gate](2026-06-21-phaseLightning-career-route-wording-gate.md) | Active | Convert Career/cohort route rows from plain partial wording to partial-by-design wording, preserving Maple Leafs non-claims around TUI handoff, optional local career-history data, and no live read fetch. |
