...
| [Phase Prince of Wales - ASPECT visual system](2026-05-09-phasePrinceOfWales-visual-system.md) | Active | Applies the DEGAS ASPECT rubric to TUI/web/CLI visual quality: shared tokens, scan rhythm, responsive polish, and screenshot/golden tests. Prince.1 baseline spec is underway in `design/specs/visual-system.md`. |
