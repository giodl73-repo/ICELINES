...
| [Pulse 02 - Identity resolution hardening](plans/pulse-02.md) | planned | R3 F-02, R4 F-02 | Stop ambiguous player-name matches from creating confident wrong player links. |
