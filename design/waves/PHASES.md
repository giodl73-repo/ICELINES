...
|---|---|---|---|
| [Call the Changes](2026-05-15-call-the-changes/WAVE.md) | active | Finish MDI as a true workbench with shared catalog identity, zone rules, and flexible ViewModel-backed pane models across TUI and web. | `MDI-WORKBENCH-INVENTORY.md`; `icelines-core/src/workbench.rs`; `icelines-cli/src/tui/workbench.rs`; `icelines-cli/src/tui/mdi.rs`; `icelines-cli/src/tui/screens/mod.rs`; `icelines-web/src/workbench.rs`; `icelines-web/src/handlers/dashboard.rs`; `icelines-web/templates/dashboard.html`; `panels/pulse-01-workbench-contract/`; `plans/pulse-01.md`; `plans/pulse-02.md`; `plans/pulse-03.md`; `plans/pulse-04.md` |
