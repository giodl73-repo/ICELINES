...
|---|---|---|---|
| [Sim the Spark](2026-05-15-sim-the-spark/WAVE.md) | active | Add descriptive Rocket Richard scoring pace and outlook contracts without betting or proprietary projection claims. | `SPARK-INVENTORY.md`; `PlayerScoringPaceView`; `TeamScoringOutlookView`; `plans/pulse-01.md`; `plans/pulse-02.md`; `plans/pulse-03.md`; `plans/pulse-04.md` |
