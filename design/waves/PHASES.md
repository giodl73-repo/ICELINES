...
|---|---|---|---|
| [Profile the Player](2026-05-14-profile-the-player/WAVE.md) | active | Define the complete player screen system, including records, streaks, awards, career arc, comparisons, and fantasy context. | `PLAYER-SCREEN-MAP.md`; `plans/pulse-01.md`; `plans/pulse-02.md`; `plans/pulse-04.md` |
