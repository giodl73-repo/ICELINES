...
|---|---|---|---|
| [Call the Changes](2026-05-15-call-the-changes/WAVE.md) | active | Finish MDI by replacing tab-first navigation with explicit screen catalog selection across TUI and web. | `plans/pulse-01.md` |
