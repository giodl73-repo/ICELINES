...
|---|---|---|---|
| [Compose the Bench](2026-05-15-compose-the-bench/WAVE.md) | active | Turn the shared workbench catalog into a composable pane system with center workspace, side panes, active fields, top-ribbon scope, and bound experiences across TUI and web. | `PANE-COMPOSITION-INVENTORY.md`; `plans/pulse-01.md`; `plans/pulse-02.md`; `plans/pulse-03.md`; `plans/pulse-04.md`; `plans/pulse-05.md`; `panels/wave-plan-review/` |
