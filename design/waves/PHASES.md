...
|---|---|---|---|
| [Measure the Finish](2026-05-14-measure-the-finish/WAVE.md) | active | Deepen Rocket Richard into player scoring trends, streak leaderboards, and owned shot-quality proxy contracts. | `plans/pulse-01.md` |
