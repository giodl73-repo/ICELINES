...
Pulse 03 made `cargo audit` vulnerability-blocking while keeping warning-class
advisories visible instead of ignored. `design/release-checklist.md` now carries
