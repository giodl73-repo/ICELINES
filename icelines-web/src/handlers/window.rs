...
pub async fn get_window(
    ...
    let html = format!(
        "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>The Window</title><link rel=\"stylesheet\" href=\"/static/style.css\"></head><body><main><h1>The Window</h1><p>Season {season} · as of {} · Frame {} · fingerprint <code>{}</code></p><p>Scores, confidence, and coverage are separate. NR means a declared comparability gate withheld rank.</p><table><thead><tr><th>Team</th><th>Score</th><th>Rank</th><th>Confidence</th><th>Coverage</th><th>Classification</th></tr></thead><tbody>{rows}</tbody></table><p><a href=\"/api/v1/window/{frame}/{season}\">Full JSON artifact</a></p></main></body></html>",
        board.as_of,
