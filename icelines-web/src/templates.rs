...
pub struct DashboardTemplate {
    ...
    pub show_full_goalies: bool,
    pub goalies_surface_html: String,
    pub show_full_depth: bool,
    pub depth_surface_html: String,
    ...
    pub show_full_game: bool,
    pub game_surface_html: String,
    ...
    pub left_pane_open_href: String,
    pub left_pane_swap_href: String,
    pub left_pane_clear_href: String,
    pub right_pane_workspace_url: String,
    pub right_pane_workspace_label: String,
    pub right_pane_workspace_summary: Vec<DashboardSummaryRow>,
    pub right_pane_open_href: String,
    pub right_pane_swap_href: String,
    pub right_pane_clear_href: String,
