...
- `organization-window-board-multisource-alp-development-2026-27.json` replaces
...
- `organization-window-impact-alp-development-2026-27.json` is the typed
...
- `icecast-alp-development-isolated-impact-2026-27.json` is the compact output
...
- `organization-window-scenario-distribution-input-alp-brv-2026-27.json`
...
- `organization-window-scenario-distribution-alp-brv-2026-27.json` is the
...
```text
icelines icecast window-build --season 20262027 --as-of 2026-07-27 --generated-at 2026-07-28T12:00:00-07:00 --team-season-forecast examples/icecast-alp-line-baseline-season.json --team-lineup examples/team-lineup-alp-2026-27.json --team-lineup examples/team-lineup-brv-2026-27.json --training-camp examples/icecast-league-training-camp-2026-27.json --out examples/organization-window-board-multisource-baseline-2026-27.json

icelines icecast window-scenario --baseline examples/organization-window-board-multisource-baseline-2026-27.json --scenario examples/organization-window-board-multisource-alp-development-2026-27.json --scenario-id nyr-development-variance --team-season-authority examples/icecast-alp-development-variance-10000-result.json --out examples/organization-window-impact-alp-development-2026-27.json

icelines icecast window-scenario-distribute --baseline examples/organization-window-board-multisource-baseline-2026-27.json --input examples/organization-window-scenario-distribution-input-alp-brv-2026-27.json --out examples/organization-window-scenario-distribution-alp-brv-2026-27.json
```
