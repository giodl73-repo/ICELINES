...
pub struct PlayoffsSeriesInput {
    ...
    pub top_name: String,
    pub top_wins: u8,
    pub top_seed_rank: Option<String>,
...
pub struct PlayoffsSeriesRow {
    ...
    pub top_name: String,
    pub top_wins: u8,
    pub top_seed_rank: String,
    pub bottom_abbrev: String,
    pub bottom_name: String,
    pub bottom_wins: u8,
    pub bottom_seed_rank: String,
    pub winner_abbrev: Option<String>,
    pub games_played: u8,
    pub summary: String,
...
fn playoffs_series_row(series: PlayoffsSeriesInput) -> PlayoffsSeriesRow {
    ...
    PlayoffsSeriesRow {
        ...
        top_seed_rank: series.top_seed_rank.unwrap_or_else(|| "—".to_string()),
        bottom_abbrev: series.bottom_abbrev,
        bottom_name: series.bottom_name,
        bottom_wins: series.bottom_wins,
        bottom_seed_rank: series.bottom_seed_rank.unwrap_or_else(|| "—".to_string()),
        winner_abbrev: series.winner_abbrev,
        games_played: series.top_wins + series.bottom_wins,
        summary,
        is_complete,
