...
pub use view_model::{
    ...
    TradeDraftPickExecutionAuthority, TradeDraftPickMissingCoordinateView,
    ...
    TradeDraftPickOwnershipStatus, TradeDraftPickSelectionRule, TradeDraftPickTeamCoverageRow,
