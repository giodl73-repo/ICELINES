...
pub use view_model::{
    ...
    ScoringEventSummary, SeasonTypeMutationIntent, SemanticToken, ShotEventKind, ShotLocation,
    ...
    TeamRecordsView, TeamRemainingSchedule, TeamScheduleStrength, TeamScoringProfileView,
