...
pub use view_model::{
    ...
    TradeDraftPickProtectionLegInput, TradeDraftPickProtectionLegView, TradeDraftPickSelectionRule,
    TradeDraftPickTeamCoverageRow, TradeExecutionAuthorityInput, TradeImpactLine, TradeImpactPair,
    TradeImpactPlayer, TradeImpactSlot, TradeLineupAssignmentKind, TradeLineupAssignmentView,
